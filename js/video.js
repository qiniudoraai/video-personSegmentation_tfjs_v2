async function main() {
                ...
                img2.src = encodeURI('http://r3dg6y3l0.hd-bkt.clouddn.com/WebRTC/bg.jpg');
                ...
                while(true) {
                    ...
                    if (viewOption === 'recurrent1') {
                        ...
                        document.getElementById('bg').style.background = 'url("http://r3dg6y3l0.hd-bkt.clouddn.com/WebRTC/bg.jpg")';
